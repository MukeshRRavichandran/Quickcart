        ...
        <div className="space-y-4">
          ...
          <form onSubmit={handleSubmit} className="flex gap-2">
            <input
              ...
              className="flex-grow px-4 py-2.5 bg-neutral-100 text-sm text-neutral-800 rounded-lg outline-none border border-transparent focus:border-primary/20 focus:bg-white transition-all"
            />
            <button
              type="submit"
